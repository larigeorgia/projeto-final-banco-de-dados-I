...
Karen: Ficou responsável pelo script SQL, fazendo a criação do banco de dados e das tabelas onde serão inseridos os dados dos funcionários e das tarefas — a parte estrutural do projeto.
...
Larica: Fez o script Python com as operações cruciais, como consultas, inserções, atualizações e remoções (CRUD). É uma parte importante, pois são recursos essenciais para uma melhor funcionalidade, evitando a necessidade de entrar no código base e fazer as mudanças manualmente.
